...
function transformJsonParameter(obj) {
  if (obj && os)
  {
    if (typeof obj.hideCart == "boolean")
      obj.hideCart = obj.hideCart == true ? "true" : "false";
    if (typeof obj.shouldReturn == "boolean")
      obj.shouldReturn = obj.shouldReturn == true ? "true" : "false";
  }
...
export class Snapcall {
    ...
    **/
    launchCallBid(bid_id, parameter){
      let st_param = transformJsonParameter(parameter);
